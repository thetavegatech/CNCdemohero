...
const ServoLoadChart = ({ machineId }) => {
  ...
  // Function to handle predefined filters
  ...
  const fetchData = async () => {
    try {
      ...
      const url = `http://localhost:5001/api/machine-data/ORG001/${machineId}/MonitoringDataLog?subType=ServoLoad&${query.toString()}`;
