...
//         </>
//       ) : (
//         <div className="container my-5 pt-4 border border-1 mt-5">
//           <Row className="text-center py-2 mb-0 mt-3">
//             <Col >
...
//               <div className="col-lg-4 col-md-6 col-sm-12 mb-3 d-flex align-items-end" style={{ width: '25%'}}>
...
//       {/* Edit Modal */}
//       <Modal show={showEditModal} onHide={handleCloseModal} className="mt-2">
